                    ...
                    <div class="pay-options">
                        <div class="payment-cols">
                            <div class="grid-view">
                                ...
                                <div class="grid-list" onclick="selectCryptoWithdraw()">
                                    <button class="btn payment-btn" data-bs-toggle="modal" data-bs-target="#withdraw-modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-1">
                    <form class="login-form text-center" action="/insert/withdrawal" method="post" id="withdraw_form">
                        ...
                        <div id="crypto_wallet_div" style="display:none;">
                            <label for="crypto_wallet_address" class="form-label text-dark">Crypto Wallet Address</label>
                            <div class="login-controls">
                                <label for="crypto_wallet_address">
                                    <input type="text" class="form-control text-indent-0" id="crypto_wallet_address" name="crypto_wallet_address" placeholder="Enter your crypto wallet address">
                                </label>
                            </div>
                            <label id="crypto_wallet_address-error" class="error" for="crypto_wallet_address"></label>
                        </div>
...
@endisset
<script>
function selectCryptoWithdraw() {
    console.log('🎯 Crypto withdrawal selected');
    $('#payment_gateway_type').val('7');
    $('#min_withdraw_amount').val('{{ setting('min_recharge') }}');
    withdraw('7', '{{ setting('min_recharge') }}');
}
</script>
@endsection