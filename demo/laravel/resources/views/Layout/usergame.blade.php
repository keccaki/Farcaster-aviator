...
<body class="dark-bg-main">
                ...
                <div class="modal-body pt-1">
                    <form class="login-form" method="post" action="#"
                        ...
                        <div class="text-center mt-2 mb-2">
                            <span class="f-12 text-muted">OR</span>
                        </div>
                        <button type="button" class="btn orange-btn md-btn custm-btn-2 mx-auto mt-1 mb-2 w-100"
                            id="magicLinkBtn">
    ...
    <!--====== Magic Link Modal Start ======-->
    <div class="modal fade l-modal" id="magic-link-modal" tabindex="-1" aria-labelledby="magic-link-modal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header login-header">
                    ...
                    <h5 class="modal-title">MAGIC LINK SENT</h5>
                </div>
                <div class="modal-body pt-0 text-center">
                    <div class="magic-link-success">
                        <div class="mb-3">
                            <span class="material-symbols-outlined" style="font-size: 48px; color: #28a745;">
                                mark_email_read
                            </span>
                        </div>
                        <h6 class="mb-3">Check Your Email!</h6>
                        <p class="f-14 text-muted mb-3">
                            We've sent a magic login link to <strong id="magic-link-email"></strong>
                        </p>
                        <div class="alert alert-info f-12 mb-3">
                            <strong>⏰ Important:</strong> The link expires in 15 minutes for your security.
                        </div>
                        <p class="f-12 text-muted mb-3">
                            Click the link in your email to instantly log in to your Aviator account. No password needed!
                        </p>
                        <div class="magic-link-tips">
                            <p class="f-12 text-muted mb-2"><strong>Can't find the email?</strong></p>
                            <ul class="f-11 text-muted text-start mb-3" style="list-style: none; padding-left: 0;">
                                <li>• Check your spam/junk folder</li>
                                <li>• Make sure you entered the correct email</li>
                                <li>• Wait a few minutes for delivery</li>
                            </ul>
                        </div>
                        <button type="button" class="btn green-btn md-btn custm-btn-2 mx-auto mb-2"
                            id="resendMagicLink">
                            <span class="material-symbols-outlined me-1" style="font-size: 16px;">
                                refresh
                            </span>
                        ...
                        <div id="resend-cooldown" class="f-12 text-warning mb-2" style="display: none;">
                            Please wait <span id="cooldown-timer"></span> seconds before requesting another link.
                        </div>
    ...
    <!-- QR Code Library for Crypto Wallets -->
    <script src="js/qrcode-simple.js"></script>
    
    <!-- Crypto Wallet Management -->
    <script src="user/crypto-wallet.js"></script>
